/**
 * Test: NA relay message client
 *
 * Same message exchange as test_libp2p_msg_client but over a relayed
 ...
 * 7. Finalize
 *
 * Usage: test_libp2p_relay_client [-p <protocol>]
 */
...
main(int argc, char *argv[])
{
    ...
    /* Give transport a moment to establish relayed connection */
    usleep(500000); /* 500ms */
